...
function updateDisplay() {
    ...
    keyvalues.forEach(item => {
        ...
        if (hex) {
            ...
            hex.innerHTML = `<img src="${defaultvalues.imgsrc}" alt="${defaultvalues.fullname}">`;
}
