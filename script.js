// authentication - to be toggled off upon release
...
const keyvalues = [
    { category: "bee", congrats: "Wonderful!", prefix: "an", icon: "🐝", fullname: "Ivy bee", sciname: "Colletes hederae", keyword: "autumn", tagline: "&quot;Come join the insect ivy league with this newcomer bee!&quot;", order: "Hymenoptera, the bees, wasps, ants and sawflies", intro: "<p>Ivy bees look similar to honey bees, but with paler, more defined stripes and without such neat pollen baskets!</p><p>They were first spotted in the UK in 2001, and are now found across most of Southern England and Wales, living quite happily amongst other species.</p>", lifecycle: "<p>Ivy bees don’t live in hives, like honey bees. Instead ivy bees live in tunnels in warm, sandy soil, often close to other ivy bees.</p><p>Adults emerge in autumn when ivy is in flower. They lay their eggs and provide for their young with ivy pollen in these tunnels.</p>", howtohelp: "<p>Let some ivy grow wild if you can! Ivy offers autumn flowers and berries, providing a much needed burst of food for ivy bees and so many other species as the cool weather approaches.</p><p>Ivy is an evergreen, so it also functions as a shelter for all kinds of creatures, all year round.</p>", outlineimgsrc: "images/ivy-bee-outline-hex.svg", fullimgsrc: "images/ivy-bee-fullcolour-hex.svg", unfoundimgsrc: "images/bee-mystery-hex.svg", animationsrc: "images/bee-animation.svg", moreinfo: "<p><b><a class=text-link target='_blank' rel='noopener noreferrer' href='https://www.wildlifetrusts.org/wildlife-explorer/invertebrates/bees-and-wasps/ivy-bee'>Learn more about this creature<span class='visually-hidden'> (opens in a new tab)</span></a></a></p>", found: false },
    { category: "beetle", congrats: "Amazing!", prefix: "a", icon: "🪲", fullname: "Lesser stag beetle", sciname: "Dorcus parallelipipedus", keyword: "wood", tagline: "&quot;Wood-n’t you give this fantastic beetle a helping hand?&quot;", order: "Coleoptera, the beetles ", intro: "<p>These awesome beetles may not quite have the size of their more famous relative, the greater stag beetle, but they’re still pretty impressive!</p><p>Adults usually come out at night during the summer, sheltering in deadwood during the day.</p>", lifecycle: "<p>Lesser stag beetles lay their eggs inside decaying deadwood, and that’s where they spend most of their quite long lives.</p><p>The larvae eat the deadwood and help break it down, whereas the adults prefer tree sap. They spend 1-2 years as larvae, and 2-3 more years as adults!</p>", howtohelp: "<p>Providing untreated dead wood is the key to helping these lovely large beetles. Consider making a pile of logs or woodchip, ideally in contact with soil to speed up the decay process.</p><p>If you have old tree stumps, leave them to break down naturally rather than removing them - the beetle larvae will do the work for you!</p>", outlineimgsrc: "images/lesser-stag-beetle-outline-hex.svg", fullimgsrc: "images/lesser-stag-beetle-fullcolour-hex.svg", unfoundimgsrc: "images/beetle-mystery-hex.svg", animationsrc: "images/beetle-animation.svg", moreinfo: "<p><b><a class=text-link target='_blank' rel='noopener noreferrer' href='https://www.wildlifetrusts.org/wildlife-explorer/invertebrates/beetles/lesser-stag-beetle'>Learn more about this creature<span class='visually-hidden'> (opens in a new tab)</span></a></a></p>", found: false },
    { category: "dragonfly", congrats: "Superb!", prefix: "a", icon: "🐉", fullname: "Common darter dragonfly", sciname: "Sympetrum striolatum", keyword: "nymph", tagline: "&quot;Are you red-dy to help this striped scarlet striker soar?&quot;", order: "Odonata, the dragonflies and damselflies", intro: "<p>Like other dragonflies, common darter dragonflies are fierce, accurate predators, first on water and then in the air.</p><p>Only the males of this species are bright red, females and young adults are more golden-brown.</p>", lifecycle: "<p>These dragonflies spend much of their life underwater, as juveniles called nymphs. They catch smaller creatures with their extendable jaws! </p><p>When they are ready, they crawl out of the water and shed their skin, becoming their adult form. After a short rest, they take to the air and resume their hunting in the skies above!</p>", howtohelp: "<p>Provide freshwater sources wherever you can. A pond is best, but it can be as small as a partially submerged sink or other container. Be sure to include an exit ramp for other wildlife!</p><p>If you don’t have the option to do this, planting a range of native wildflowers will support the small insects that dragonflies feed on, helping them too!</p>", outlineimgsrc: "images/darter-dragonfly-outline-hex.svg", fullimgsrc: "images/darter-dragonfly-fullcolour-hex.svg", unfoundimgsrc: "images/dragonfly-mystery-hex.svg", animationsrc: "images/dragonfly-animation.svg", moreinfo: "<p><b><a class=text-link target='_blank' rel='noopener noreferrer' href='https://www.wildlifetrusts.org/wildlife-explorer/invertebrates/dragonflies/common-darter'>Learn more about this creature<span class='visually-hidden'> (opens in a new tab)</span></a></a></p>", found: false },
    { category: "hoverfly", congrats: "Marvellous!", prefix: "a", icon: "🪰", fullname: "Marmalade hoverfly", sciname: "Episyrphus balteatus", keyword: "aphid", tagline: "&quot;Come and jam with this agile pollinator!&quot;", order: "Dipetra, the flies", intro: "<p>Marmalade hoverflies have wasp-like stripes to help trick potential predators into leaving them well alone, even though they don’t have any sting!</p><p>You can tell them apart from wasps or bees by looking for their huge eyes, and the hovering flight they are named after.</p>", lifecycle: "<p>Marmalade hoverflies lay their eggs on plants with aphids on them. When the larvae hatch, they feast on these aphids continually as they grow.</p><p>As adults, they become agile pollinators, flying from flower to flower, using their big eyes to scope out food and avoid danger.</p>", howtohelp: "<p>Hoverflies don’t have long tongues like bees, so they especially love open flowers rather than tube-shaped ones. Their favourites include cow parsley, tansy, asters, knapweed, apple blossom and more.</p><p>Plant these, and they’ll thank you by helping take care of aphid pests for you!</p>", outlineimgsrc: "images/marmalade-hoverfly-outline-hex.svg", fullimgsrc: "images/marmalade-hoverfly-fullcolour-hex.svg", unfoundimgsrc: "images/hoverfly-mystery-hex.svg", animationsrc: "images/hoverfly-animation.svg", moreinfo: "<p><b><a class=text-link target='_blank' rel='noopener noreferrer' href='https://www.wildlifetrusts.org/wildlife-explorer/invertebrates/flies/marmalade-fly'>Learn more about this creature<span class='visually-hidden'> (opens in a new tab)</span></a></a></p>", found: false },
    { category: "bug", congrats: "Terrific!", prefix: "a", icon: "🛡️", fullname: "Green shield bug", sciname: "Palomena prasina", keyword: "sap", tagline: "&quot;Will you let this sturdy bug through your defences, and go green for them?&quot;", order: "Hemiptera, the true bugs", intro: "<p>Shield bugs are named after their shape, rather than any particular defensive capabilities, so be gentle with them!</p><p>They are also green by name and green by nature, but only for some of the year. Their summer green outfit turns more brown or bronze coloured in the late autumn, rather like the leaves they live on!</p>", lifecycle: "<p>Green shield bugs feed by sucking up sap from various plants, and lay clusters of eggs on the undersides of leaves. </p><p>The youngsters hatch in late spring, and go through five juvenile stages of growing and moulting. Adults hibernate through the winter, and the cycle continues.</p>", howtohelp: "<p>Green shield bugs are quite easy to please, so providing a range of trees, shrubs and herbaceous plants will suit them well.</p><p>Also, leave some places for them to shelter over winter, such as leaf piles. These are a lifeline for all sorts of little creatures during the cold months.</p>", outlineimgsrc: "images/green-shield-bug-outline-hex.svg", fullimgsrc: "images/green-shield-bug-fullcolour-hex.svg", unfoundimgsrc: "images/bug-mystery-hex.svg", animationsrc: "images/bug-animation.svg", moreinfo: "<p><b><a class=text-link target='_blank' rel='noopener noreferrer' href='https://www.wildlifetrusts.org/wildlife-explorer/invertebrates/bugs/common-green-shieldbug'>Learn more about this creature<span class='visually-hidden'> (opens in a new tab)</span></a></a></p>", found: false },
...
function updateProfilesContent() {
    document.querySelectorAll(".profile").forEach(profile => {
        ...
        setField(profile, "moreinfo", data.moreinfo);
...
function getHomepageTextMessages() {
    ...
    if (foundCount === 0) {
        ...
        return {
            message: "<p>Hooray! You've completed the Creature Seekers trail!</p><p>Hexie hint: You've now unlocked the quiz! Also, please tell us your thoughts on the Feedback page.</p>",
        };
    }
}
